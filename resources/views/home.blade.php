                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                           ...
                           aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/images/users/profile.png')}}" alt="user"
                                                                           class="profile-pic"/></a>
                        <div class="dropdown-menu dropdown-menu-right scale-up">
                            <ul class="dropdown-user">
                                <li>
                                    <div class="dw-user-box">
                                        <div class="u-img"><img src="{{asset('assets/images/users/profile.png')}}" alt="user">
                                        </div>
                                        <div class="u-text">
                                            <h4>Steave Jobs</h4>
            ...
            <div class="user-profile"
                ...
                <div class="profile-text"><a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu animated flipInY"><a href="#" class="dropdown-item"><i
                        ...
                        <a href="javascript:void(0)" onclick="$('#logout-form').submit()" class="dropdown-item"><i class="fa fa-power-off"></i>
                            Logout</a>
                    </div>
                </div>
            </div>
